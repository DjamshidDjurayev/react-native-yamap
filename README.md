## Изменения
- Для версии Андроид добавлен YandexMapKit версия 4.0.0-lite, уменьшенная версия, перенесена инициализация в нативный код
- Для версии Айос указана версия 3.4, так как в версии 3.5 (которая скачивается автоматически) проблема с биткодом, удален код по установлению локали, так как в версии 3.4 его нет. 
